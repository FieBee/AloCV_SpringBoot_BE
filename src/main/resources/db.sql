...
select * from job;
insert into job(id, created_at, updated_at, description, experience, expired_date, gender, job_type, name, position, recruit_number, salary_range, company_id, job_field_id, location_id, status) value (1, '2022-01-01', '2022-01-02', 'Môi trường làm việc thân thiện, lộ trình thăng tiến rõ ràng, làm từ t2 đến t6', 'Yêu cầu: Tốt nghiệp bằng khá đại học trở lên, tối thiểu 1 năm kinh nghiệm', '2022-03-21', 'Nữ', 'Nhân viên văn phòng', 'Kế Toán Lao Động Tiền Lương', 'Nhân viên Kế toán', 1, 9000000, 1, 1, 1 ,1);
insert into job(id, created_at, updated_at, description, experience, expired_date, gender, job_type, name, position, recruit_number, salary_range, company_id, job_field_id, location_id, status) value (2, '2022-02-11', '2022-02-15', 'làm full time, thời gian làm việc linh hoạt', 'Yêu cầu: Tốt nghiệp C3 trở lên', '2022-09-15', 'Nam Nữ', 'Lao Động chân tay', 'Công nhân Xưởng hóa chất', 'Công nhân', 50, 7000000, 2, 10, 4 ,1);
insert into job(id, created_at, updated_at, description, experience, expired_date, gender, job_type, name, position, recruit_number, salary_range, company_id, job_field_id, location_id,status) value (3, '2022-04-04', '2022-04-17', 'Môi trường sạch sẽ, thân thiện, thời gian làm việc linh hoạt', 'Yêu cầu: Tốt nghiệp đại học kiến trúc khoa đồ họa', '2022-09-22', 'Nam Nữ', 'Thiết kế đồ họa', 'Chuyên Viên Thiết Kế Đồ Họa', 'Nhân viên', 5, 10000000, 3, 12, 2,1 );
insert into job(id, created_at, updated_at, description, experience, expired_date, gender, job_type, name, position, recruit_number, salary_range, company_id, job_field_id, location_id,status) value (4, '2022-04-13', '2022-04-29', 'Phản hồi và tư vấn nhu cầu/thắc mắc của khách hàng liên quan đến sản phẩm/dịch vụ doanh nghiệp cung cấp', 'Yêu cầu: Ưu tiên các bạn có kinh nghiệm trong ngành customer service hoặc dịch vụ', '2022-09-25', 'Nữ', 'Chuyên viên tư vấn, chăm sóc khách hàng', 'Nhân Viên Sale Online ', 'Nhân viên TeleSale', 20, 15000000, 5, 16, 1 ,1);
insert into job(id, created_at, updated_at, description, experience, expired_date, gender, job_type, name, position, recruit_number, salary_range, company_id, job_field_id, location_id,status) value (5, '2022-04-03', '2022-04-24', 'Tiếp nhận, làm thủ tục và hỗ trợ cho nhân viên mới nhận việc', 'Yêu cầu: Tốt nghiệp Đại học, Cao đẳng chuyên ngành liên quan', '2022-11-30', 'Nam Nữ', 'Nhân viên văn phòng', 'Nhân Viên Hành Chính Nhân Sự', 'Nhân viên phòng hành chính', 7, 11000000, 9, 13, 3 ,1);
insert into job(id, created_at, updated_at, description, experience, expired_date, gender, job_type, name, position, recruit_number, salary_range, company_id, job_field_id, location_id,status) value (6, '2022-05-05', '2022-05-26', 'Nhận lớp giảng dạy theo lịch của Phòng Đào tạo và giảng dạy đúng tiến độ, đảm bảo chuẩn theo giáo trình Trung tâm và mục tiêu khoá học.', 'Yêu cầu: Điểm kỹ năng nói đạt từ 6.5 trở lên (IELTS) hoặc tương đương, phát âm chuẩn', '2022-11-01', 'Nữ', 'Giáo viên', 'Giáo Viên Tiếng Anh', 'Giảng viên', 10, 12000000, 8, 15, 5 ,1);
insert into job(id, created_at, updated_at, description, experience, expired_date, gender, job_type, name, position, recruit_number, salary_range, company_id, job_field_id, location_id,status) value (7, '2022-05-05', '2022-05-23', 'Nghiên cứu và phát triển thị trường trong lĩnh vực cung ứng nguồn nhân lực trong và ngoài nước', 'Yêu cầu: Tốt nghiệp đại học trở lên chuyên ngành quản trị kinh doanh, Luật, Marketing,', '2022-12-06', 'Nam Nữ', 'Quản lý bộ phận kiêm tìm hiểu thị trường', 'Giám Đốc Kinh Doanh', 'Giám Đốc', 1, 20000000, 9, 17, 6,1 );
insert into job(id, created_at, updated_at, description, experience, expired_date, gender, job_type, name, position, recruit_number, salary_range, company_id, job_field_id, location_id,status) value (8, '2022-05-14', '2022-05-20', 'Đón tiếp khách hàng, ứng viên, sắp xếp phòng họp khi cần', 'Yêu cầu: Ngoại hình ưa nhìn , chiều cao từ 1m6 trở lên', '2022-08-04', 'Nữ', 'Tiếp khách hàng', 'Nhân Viên Lễ Tân Hành Chính', 'Nhân viên lễ tân', 3, 8000000, 7, 13, 7 ,1);
insert into job(id, created_at, updated_at, description, experience, expired_date, gender, job_type, name, position, recruit_number, salary_range, company_id, job_field_id, location_id,status) value (9, '2022-05-12', '2022-05-18', 'Coding theo đúng chuẩn coding convention, các quy ước về gitflow, module mà team đã quy định.', 'Yêu cầu: Có tư duy logic tốt, có tinh thần học hỏi, chủ động công việc.', '2022-07-09', 'Nam', 'Code', 'Lập Trình Viên Java - Backend Developer ', 'Nhân viên', 6, 17000000, 6, 5, 8, 1 );
insert into job(id, created_at, updated_at, description, experience, expired_date, gender, job_type, name, position, recruit_number, salary_range, company_id, job_field_id, location_id,status) value (10, '2022-06-09', '2022-06-18', 'Quản lý hệ thống và phát triển khách hàng theo data có sẵn.', 'Yêu cầu: Có kinh nghiệm 1 năm bán hàng hoặc quản lý khu vực ở vị trí tương đương', '2022-09-21', 'Nam Nữ', 'Chăm sóc khách hàng', 'Nhân Viên Kinh Doanh', 'Nhân viên', 20, 10000000, 5, 13, 9 , 1);
